...
def generate_summaries(texts, tokenizer, model, max_length=100, num_beams=4):
    inputs = tokenizer(texts, max_length=512, return_tensors='pt', truncation=True, padding=True)
